                    ...
                    <div class="container">
                        <div class="help-header-container">
                            ...
                            <div class="help-left-container">
                                <div class="bioauth-header-img" onclick="BackToCommunity()">
                            ...
                            <div class="member-container">
                                ...
                                <div class="container">
                                    <div class="comment-post-wrap">
                                        ...
                                        <!-- Right container -->
                                        <div><div class="comm-post-date" id="bio-datecomm-post-id"></div></div>
                                    </div>
                    ...
                    <div class="comm-chat-bottom">
                        ...
                        <div class="container" id="edit-comment-post">
                            <div class="receive-send-link-btn">
                                ...
                                <input type="text" placeholder="Message" onchange="editClientInput(event)" class="edit-message-input-style" id="client-edit-comment-input-style">
                                <div class="bio-chat-right-wrap" style="cursor: pointer;" onclick="editClientComment()">
                                    <div class="bio-send-right-img">
                                        <img src="svg/send.svg" class="img-fluid">
                                    </div>
                                </div>
