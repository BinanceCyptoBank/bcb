            ...
            <div class="menu-page-display page-display">
                ...
                <!-- -------------------- -------------------- MENU PAGE PARENT CONTAINER -------------------- -------------------- -->
                    <div class="menu-parent-container">
                        ...
                        <!-- -------------------- Community Link -------------------- -->
                        <div class="menu-option-wrapper" onclick="HomeToCommunity()" id="menu13">
                            <div class="container">
                                <div class="menu-option-container">
                                    <div class="menu-option-left-container">
                                        <div class="menu-option-img">
                                    ...
                                    <div class="menu-option-right-img"><div class="community-online-dot" id="onlineChatDisplay"></div></div>
                                </div>
                            </div>
                        </div>
                        <!-- -------------------- -------------------- -------------------- -->
