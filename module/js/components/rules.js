                            ...
                            <div class="help-header-container">
                                ...
                                <div class="help-left-container">
                                    <div class="help-header-img btn-display">
                                        <img src="svg/arrowleft.svg" onclick="BackToReferral()" class="img-fluid">
                                    </div>
                    ...
                    <div class="rulespolicy-parent">
                        ...
                        <!-- --------------------  -------------------- -->
                            <div class="container">
                                ...
                                <p class="rulespolicy-sm-txt">When your referred friend registers an account with Binance and makes a deposit through the link you have shared, both of you will benefit - you will receive double their first deposit amount, and your referred friend will receive six times the value they have deposited (for a total of eight times the initial deposit).</p>
                                
                                <!--  -->
                                <p class="line-height-zero rulepolicy-lg-txt">2. Who is a valid user?</p>
                                <p class="rulespolicy-sm-txt">A. The invitee's should be one that has not yet been registered and verified with Binance CryptoBank as at the time the inviter makes hes first deposit.
                                <br>
                                B. After signing up on Binance CryptoBank, the invitee should make deposits to get x6 their deposit.</p>
                                ...
                                <p class="rulespolicy-sm-txt">A new user can only be bound by the inviter once, and one device and account can only participate once. Should there be any suspicious invitations, Binance reserves the right to withhold any rewards that may apply. There are a variety of uncertain factors on the internet, so please understand and accept that Binance CryptoBank holds the right to take measures such as eliminating irregularities or adjusting, suspending or canceling this event via different means due to unforeseen occurrences like force majeure, network issues, communication line failure, massive computer paralysis or large-scale cheating during this activity - without being held liable for any consequent losses incurred by you.</p>
