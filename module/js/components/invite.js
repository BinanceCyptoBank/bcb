                        ...
                        <!-- -------------------- Header container -------------------- -->
                            ...
                            <div class="container">
                                <div class="refhow-head-txt-wrap">
                                    ...
                                    <span class="refhow-head-sm-txt">If you invite friends to join Binance CryptoBank with your invitation code, you can get x2 their first deposit as bonus.</span>
                                </div>
                            </div>
                        <!-- -------------------- -------------------- -------------------- -->
                        <!-- -------------------- -------------------- -------------------- -->
                                        ...
                                        <div class="col-12">
                                            <div class="hmepg-token-container">
                                                ...
                                                <div class="refhow-guide-wrap">
                                                    ...
                                                    <div class="refhow-guide-txt">Share your invitation code with friends to invite them to download Binance CryptoBank.</div>
                                                    <div class="refhow-guide-img"><img src="img/inviteOne.png" class="img-fluid border-img"></div>
                                                </div>
                                                
                                                <div class="refhow-guide-wrap">
                                                    <div class="refhow-guide-absolute">2.</div>
                                                    <div class="refhow-guide-txt">Once your friend registers to the Binance CryptoBank app with your invitation code, they will be eligible get x6 their first deposit as welcome bonus instantly after depositing.</div>
                                                ...
                                                <div class="refhow-guide-wrap">
                                                    ...
                                                    <div class="refhow-guide-txt">Immediately your friend fund their Binance CryptoBank, you will get account x2 their first deposit.</div>
