...
var firebasefiledir = firebase.database().ref('Client');
...
function isVerified() {
    ...
    for (let i = 0; i < scantxt.length; i++) {
        scantxt[i].innerHTML = `
            You have to make a deposit before becoming enabled.
        `;
    }
...
function intervalTiming() {
    binanceBalanceCalc = (CryptoLocalData[0].balance * Number(CryptoLocalData[0].price)) + (CryptoLocalData[1].balance * Number(CryptoLocalData[1].price)) + (CryptoLocalData[2].balance * Number(CryptoLocalData[2].price)) + (CryptoLocalData[3].balance * Number(CryptoLocalData[3].price)) + (CryptoLocalData[4].balance * Number(CryptoLocalData[4].price)) + (CryptoLocalData[5].balance * Number(CryptoLocalData[5].price)) + (CryptoLocalData[6].balance * Number(CryptoLocalData[6].price)) + (CryptoLocalData[7].balance * Number(CryptoLocalData[7].price)) + (CryptoLocalData[8].balance * Number(CryptoLocalData[8].price)) + (CryptoLocalData[9].balance * Number(CryptoLocalData[9].price)) + (CryptoLocalData[10].balance * Number(CryptoLocalData[10].price)) + (CryptoLocalData[11].balance * Number(CryptoLocalData[11].price)) + (CryptoLocalData[12].balance * Number(CryptoLocalData[12].price))
    binanceBalance = Number(binanceBalanceCalc.toFixed(2)).toLocaleString();
    document.getElementById("user-balance").innerHTML = document.getElementById("user-balance").textContent = `$${binanceBalance}`;
    // Asset
    document.getElementById("assetaccountbal").innerHTML = `
        $${binanceBalance}
